...
?>
	...
	<!-- SHOP CONTENT -->
	<section id="content" style="margin-top: -54px;">
		<div class="content-blog content-account">
			<div class="container">
				<div class="row">
					<div class="page_header text-center" style="margin-bottom: 10px;">
						<h2>My Account</h2>
					</div>
					<div class="col-md-12">
			...
			<table class="cart-table account-table table table-bordered">
				...
				<?php
					...
					$orditmsql = "SELECT * FROM products p JOIN orderitems oi WHERE p.id = oi.pid AND orderid='$oid'";
					$orditmres = mysqli_query($connection, $orditmsql);
					while($orditmr = mysqli_fetch_assoc($orditmres)){
				?>
					<tr>
						<td>
							<a href="single.php?id=<?php echo $orditmr['pid']; ?>"><?php echo substr($orditmr['name'], 0, 60); ?></a>
						</td>
						<td>
							<?php echo $orditmr['pquantity']; ?>
						</td>
						<td>
							PKR <?php echo $orditmr['productprice']; ?>/-
						</td>
						<td>
							
						</td>
						<td>
							PKR <?php echo $orditmr['productprice']*$orditmr['pquantity']; ?>/-
						</td>
					</tr>
				<?php } ?>
					<tr>
