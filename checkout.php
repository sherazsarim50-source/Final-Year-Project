...
$title = "Checkout - Best Clothing Online Shopping";	
...
<div class="container">
						...
						<div class="space30"></div>
							...
							<div class="row">
								<div class="col-md-6">
									...
									<input required name="fname" class="form-control" placeholder="" value="<?php if(!empty($r['firstname'])){ echo $r['firstname']; } elseif(isset($fname)){ echo $fname; } ?>" type="text">
								</div>
								<div class="col-md-6">
									<label>Last Name </label>
									<input required name="lname" class="form-control" placeholder="" value="<?php if(!empty($r['lastname'])){ echo $r['lastname']; }elseif(isset($lname)){ echo $lname; } ?>" type="text">
								</div>
							</div>
							<div class="clearfix space20"></div>
							...
							<div class="clearfix space20"></div> -->
							<label>Address </label>
							<input required name="address1" class="form-control" placeholder="Street address" value="<?php if(!empty($r['address1'])){ echo $r['address1']; } elseif(isset($address1)){ echo $address1; } ?>" type="text">
							<div class="clearfix space20"></div>
							...
							<div class="row">
								<div class="col-md-4">
									<label>City </label>
									<input required name="city" class="form-control" placeholder="City" value="<?php if(!empty($r['city'])){ echo $r['city']; }elseif(isset($city)){ echo $city; } ?>" type="text">
								</div>
								<div class="col-md-4">
									<label>State</label>
									<input required name="state" class="form-control" value="<?php if(!empty($r['state'])){ echo $r['state']; }elseif(isset($state)){ echo $state; } ?>" placeholder="State" type="text">
								</div>
								<div class="col-md-4">
							...
							<div class="clearfix space20"></div>
							<label>Phone </label>
							<input required name="phone" class="form-control" id="billing_phone" placeholder="" value="<?php if(!empty($r['mobile'])){ echo $r['mobile']; }elseif(isset($phone)){ echo $phone; } ?>" type="text">
			...
			<table class="table table-bordered extra-padding">
				<tbody>
					<tr>
						<th>Cart Subtotal</th>
						<td>PKR <?php echo $total; ?>.00/-</span></td>
					</tr>
					<tr>
					...
					<tr>
						<th>Order Total</th>
						<td><strong>PKR <?php echo $total; ?>.00/-</span></strong> </td>
					</tr>
				</tbody>
			</table>
			<?php } ?>
			...
			<div class="payment-method">
				<div class="row">
						...
						<div class="col-md-4">
							<input name="payment" id="radio1" class="css-checkbox" type="radio" value="cod" required><span>Cash On Delivery</span>
				...
				<div class="space30"></div>
				<input type="submit" class="button btn-lg" value="Pay Now" style="padding: 10px 25px;">
			</div>
		</div>		
</form>		
		</div>
