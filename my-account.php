...
$title = "Your Account - Best Clothing Online Shopping";
...
?>
	...
	<section id="content"   style="margin-top: -54px;">
		<div class="content-blog content-account">
			...
			<table class="cart-table account-table table table-bordered">
				...
				?>
					<tr>
						...
						<td>
							PKR <?php echo $ordr['totalprice']; ?>/-
						</td>
						<td>
							<a href="view-order.php?id=<?php echo $ordr['id']; ?>">View</a>
							<?php if($ordr['orderstatus'] != 'Cancelled' && $ordr['orderstatus'] != 'Dispatched'){?>
			...
			<div class="ma-address" style="margin-top: -54px;">
						<h3>My Addresses</h3>
