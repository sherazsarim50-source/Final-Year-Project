	...
	<div class="content-blog">
		<div class="container">
			<table class="table table-striped">
				...
				<tbody>
				<?php 	
					$sql = "SELECT o.id, o.totalprice, o.orderstatus, o.paymentmode, o.`timestamp`, u.firstname, u.lastname, u.address1, u.city, u.state, u.zip, u.mobile FROM orders o JOIN usersmeta u WHERE o.uid=u.uid ORDER BY o.id DESC";
