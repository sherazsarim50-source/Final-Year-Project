...
<head>
	...
	<title>Shop Admin Login - Libkart Ecommerce</title>

	<!-- Mobile Metas -->
	<meta name="viewport" content="width=device-width, initial-scale=1.0">

	<!-- Favicon -->
	<link rel="shortcut icon" href="inc/lib-ico.svg">
							...
							<div class="row">
								<div class="form-group">
									<div class="col-md-12">
										...
										<input type="email" name="email" value="" class="form-control" placeholder="e.g. falaw@libkart.com">
									</div>
								</div>
							</div>
