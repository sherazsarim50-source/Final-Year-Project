...
$title = "Libkart Product - Best Clothing Online Shopping";
...
?>
	...
	<!-- SHOP CONTENT -->
	<section id="content">
		<div style="padding-top: 0px;" class="content-blog singleAdjust">
			<div class="container">
				<div class="row">
			...
			<?php if(isset($smsg)){ ?><div class="alert alert-success" role="alert"> <?php echo $smsg; ?> </div><?php } ?>
					<div class="row">
							...
							<div class="gal-wrap">
								<div id="gal-slider" class="flexslider">
									<ul class="slides">
										...
										<li><img src="admin/<?php echo $prodr['thumb1']; ?>" class="img-responsive" alt=""/></li>
									</ul>
								</div>
								<ul class="gal-nav">
									<li>
									...
									<li>
										<div>
											<img src="admin/<?php echo $prodr['thumb1']; ?>" class="img-responsive" alt=""/>
										</div>	
									</li>
								</ul>
						...
						<div class="col-md-7 product-single">
							...
							<div class="p-price">PKR <?php echo $prodr['price']; ?>.00/-</div>
							...
							<div class="space10" style="padding: 7px;"></div>
							<a class   href="addtowishlist.php?id=<?php echo $prodr['id']; ?>">Add to WishList</a>
							<div class="product-meta">
								...
								$prodcatr = mysqli_fetch_assoc($prodcatres);
								 ?>
								<a href="categories.php?id=<?php echo $prodcatr['id']; ?>"><?php echo $prodcatr['name']; ?></a></span><br>
								</div>
								</div>
								</div>
							...
							<div style="" class="tab-pane fade" id="mini-three">
								...
								<?php
								 ...
								 ?>
									...
									?>
										<li>
											<a class="pull-left" href="#"><img class="comment-avatar" src="assets/img/default.jpg" style="border-radius: 11px;" alt="" height="50" width="50"></a>
									...
									<?php 
										...
										$chkrevsql = "SELECT count(*) reviewcount FROM reviews r WHERE r.pid=$id";
							 ...
							 ?>
								<div class="sm-item isotope-item">
									<div class="product">
										...
										<div class="product-price">PKR <?php echo $relr['price']; ?>.00/-<span></span></div>
									</div>
								</div>
							<?php } ?>
							</div>
